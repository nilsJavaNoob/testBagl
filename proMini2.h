...
dht DHT;                                        // Датчики
bool infoScreen=false;// Признак отображениея иформационного экрана  1 - на экран ничего не выводится кроме информ экрана
...
struct type_sensors                                 // структура для усреднения
{
       ...
       long  sum_tOut=-5000,sum_tIn=-5000;// Сумма для усреднения Текущие температуры в сотых градуса !!! место эконо
